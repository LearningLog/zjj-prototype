  ...
  <div>
    ...
    <el-tabs type="border-card">
      <el-tab-pane label="基本信息">
        <el-form inline ref="product" status-icon :model="product" label-width="140px" size="small" class="productForm">
          <el-col :span="12">
            <el-form-item label="策划编号">
              <el-input v-model="product.skuId" disabled></el-input>
            </el-form-item>
            <el-form-item label="项目类型" prop="projectType">
              <el-select v-model="product.a" placeholder="请选择项目类型" class="projectType" filterable>
            ...
            <el-form-item label="采购方式" prop="barCode">
              <el-select v-model="product.b" placeholder="请选择采购方式" class="purchaseType" filterable>
            ...
            <el-form-item label="所在地" prop="fraction">
              <el-select v-model="product.d" placeholder="请选择所在地" class="purchaseType" filterable>
            ...
            <el-form-item label="有无备案" prop="minPurchaseNum">
              <el-select v-model="product.e" placeholder="请选择" class="purchaseType" filterable>
            ...
            <el-form-item label="编制部门" prop="fraction">
              <el-select v-model="product.h" placeholder="请选择编制部门" class="purchaseType" filterable>
            ...
            <el-form-item label="采购组织单位" prop="fraction">
              <el-select v-model="product.i" placeholder="请选择采购组织单位" class="purchaseType" filterable>
          ...
          <el-col :span="12">
            ...
            <el-form-item label="工程类型" prop="manufacturerName">
              <el-select v-model="product.k" placeholder="请选择工程类型" class="purchaseType" filterable>
            ...
            <el-form-item label="评标方式" prop="model">
              <el-select v-model="product.l" placeholder="请选择评标方式" class="purchaseType" filterable>
            ...
            <el-form-item label="汇率" prop="salePrice">
              <el-input v-model="product.exchangeRate" :disabled="isDisableRate"></el-input>
            </el-form-item>
            <el-form-item label="有效合同额" prop="increaseNum">
              <el-input v-model="product.increaseNum"></el-input>
            </el-form-item>
            <el-form-item label="有无有合作投标">
              <el-select v-model="product.m" placeholder="请选择" class="purchaseType" filterable>
            ...
            <el-form-item label="编制单位">
              <el-select v-model="product.n" placeholder="请选择编制单位" class="purchaseType" filterable>
                <el-option v-for="item in establishUnitList" :label="item.name" :value="item.id" :key="item.id"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="需求单位">
              <el-select v-model="product.o" placeholder="请选择需求单位" class="purchaseType" filterable>
          ...
          <el-col :span="24" class="col24">
            <el-form-item label="项目概述">
              <el-input type="textarea" :cols="100"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
  ...
  watch: {
    product: {
      handler (curVal, oldVal) {
        switch (curVal.moneyType) {
          case 1:
            this.product.exchangeRate = '1.0000'
            this.isDisableRate = true
            break
          case 2:
            this.product.exchangeRate = ''
